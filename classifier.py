...
def layers(x_f, x_l, is_training):
    ...
    with tf.name_scope('dnn'):
        ...
        x_fc1 = tf.keras.layers.Dense(units=200, activation=tf.nn.relu, use_bias=True,
        ...
        x_fc2 = tf.keras.layers.Dense(units=400, activation=tf.nn.relu, use_bias=True,
                                      kernel_initializer=tf.keras.initializers.TruncatedNormal,
